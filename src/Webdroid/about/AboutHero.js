...
import { varFadeIn, varFadeInUp, varWrapEnter, varFadeInRight, TextAnimate } from '../../components/animate';

import Lottie from 'react-lottie';
import animationData from '../../lotties/user-profile.json';
    ...
    <>
      <RootStyle initial='initial' animate='animate' variants={varWrapEnter}>
        ...
        <Container maxWidth='lg'>
          <Container maxWidth='lg' sx={{ position: 'relative', height: 'fit-content' }}>
            <ContentStyle>
              ...
              <motion.div variants={varFadeInRight}>
                ...
                >
                  ...
                  <br /> make awesome sites easily
                  <br /> and make a whole new tech world
                </Typography>
              </motion.div>
            </ContentStyle>
          </Container>
